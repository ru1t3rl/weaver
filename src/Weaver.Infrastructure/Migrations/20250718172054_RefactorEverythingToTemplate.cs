...
{
    /// <inheritdoc />
    public partial class RefactorEverythingToTemplate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTemplateOptions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "ServiceTemplateServiceTemplateOption",
                columns: table => new
                {
                    ConfigId = table.Column<long>(type: "bigint", nullable: false),
                    ServiceTemplateId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTemplateServiceTemplateOption", x => new { x.ConfigId, x.ServiceTemplateId });
                    table.ForeignKey(
                        name: "FK_ServiceTemplateServiceTemplateOption_ServiceTemplateOptions~",
                        column: x => x.ConfigId,
                        principalTable: "ServiceTemplateOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceTemplateServiceTemplateOption_ServiceTemplates_Servi~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTemplateOptions_Uuid",
                table: "ServiceTemplateOptions",
                column: "Uuid",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTemplates_Uuid",
                table: "ServiceTemplates",
                column: "Uuid",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTemplateServiceTemplateOption_ServiceTemplateId",
                table: "ServiceTemplateServiceTemplateOption",
